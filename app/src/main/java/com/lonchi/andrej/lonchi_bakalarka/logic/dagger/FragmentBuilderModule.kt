...
import com.lonchi.andrej.lonchi_bakalarka.ui.discover.byIngredients.DiscoverByIngredientsCameraFragment
...
abstract class FragmentBuilderModule {
    ...
    @ContributesAndroidInjector(modules = [MoreCustomRecipeModule::class])
    abstract fun contributeMoreCustomRecipeBottomSheet(): MoreCustomRecipeBottomSheet

    @ContributesAndroidInjector(modules = [AddToMealPlanModule::class])
    abstract fun contributeAddToMealPlanBottomSheet(): AddToMealPlanBottomSheet

    @ContributesAndroidInjector(modules = [RemoveFromMealPlanModule::class])
    abstract fun contributeRemoveFromMealPlanBottomSheet(): RemoveFromMealPlanBottomSheet
    ...
    @ContributesAndroidInjector(modules = [DiscoverByIngredientsCameraModule::class])
    abstract fun contributeDiscoverByIngredientsCameraFragment(): DiscoverByIngredientsCameraFragment
